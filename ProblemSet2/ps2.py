...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        pos: a Position
        """
        cleanTilePosition = Position(math.floor(pos.getX()), math.floor(pos.getY()))

        if self.isTileCleaned(cleanTilePosition.getX(),cleanTilePosition.getY()) == False:
            self.cleaned_tiles.append(cleanTilePosition)
    ...
    def isTileCleaned(self, m, n):
        ...
        for current_tile in self.cleaned_tiles:
            if (current_tile.getX() == m) and (current_tile.getY() == n):
                tile_cleaned = True
                break
...
class Robot(object):
    ...
    def __init__(self, room, speed):
        ...
        self.room = room
        self.speed = speed
        self.robotPosition = Position(random.randrange(room.width), random.randrange(room.height))
...
print runSimulation(1, 1.0, 10, 10, 0.9, 1, RandomWalkRobot)
