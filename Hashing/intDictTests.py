...
def findMaxClassSize(numBuckets):

    for i in range(250, 0, -1):
        if collision_prob(numBuckets, i) < 0.99:
            print 'max class size - ', i
            break
